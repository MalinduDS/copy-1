...
import { UploadIcon, MagicWandIcon, PaletteIcon, SunIcon, BackgroundIcon } from './icons';
...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect }) => {
  ...
  return (
    <div 
      className={`w-full max-w-7xl mx-auto text-center p-8 transition-all duration-300 rounded-2xl border bg-gradient-to-br from-gray-900/70 via-black/40 to-gray-900/70 backdrop-blur-lg ${isDraggingOver ? 'bg-blue-500/10 border-dashed border-blue-400' : 'border-white/10'}`}
        ...
        <div className="mt-16 w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                 ...
                 <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
                       <BackgroundIcon className="w-6 h-6 text-blue-400" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-100">Swap Backgrounds</h3>
                    <p className="mt-2 text-gray-400">Place your subject in a new environment. Upload a background and let the AI seamlessly blend them together.</p>
                </div>
                <div className="bg-black/20 p-6 rounded-lg border border-gray-700/50 flex flex-col items-center text-center">
                    <div className="flex items-center justify-center w-12 h-12 bg-gray-700 rounded-full mb-4">
