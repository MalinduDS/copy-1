...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Cinematic Moody', prompt: 'Apply a cinematic, moody color grade with deep, crushed blacks, desaturated tones, and a slight teal and orange look.' },
    { name: 'Black & White', prompt: 'Convert the image to a high-contrast, dramatic black and white with deep blacks and bright whites.' },
    { name: 'Vibrant Colors', prompt: 'Boost the vibrance and saturation of the colors in the image to make them pop, without looking unnatural.' },
    { name: 'Soft Focus', prompt: 'Apply a soft, dreamy focus effect to the entire image, giving it a gentle and ethereal feel.' },
    { name: 'Increase Contrast', prompt: 'Increase the image contrast for a more dramatic and punchy look, ensuring details are preserved' },
    { name: 'HDR Effect', prompt: 'Apply an HDR effect to enhance dynamic range, bringing out detail in both the shadows and highlights for a rich, high-fidelity look' },
  ];
